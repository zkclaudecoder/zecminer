...
{
public:
	MinerFactory(bool use_xenoncat, bool use_cuda_djezo, bool use_silentarmy, bool use_cuda_blackwell = false)
		: _use_xenoncat(use_xenoncat), _use_cuda_djezo(use_cuda_djezo), _use_silentarmy(use_silentarmy), _use_cuda_blackwell(use_cuda_blackwell) {
	}
...
private:
	...
	bool _use_cuda_blackwell = false;
